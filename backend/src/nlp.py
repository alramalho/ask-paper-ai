...
async def ask_paper(question: str, paper: Paper, merge_at_end=True, results_speed_trade_off: int = 0):
    ...
    paper.filter_sections(
        'exclude', ['reference', 'acknow', 'appendi', 'decl', 'supp'])
    ...
    prompt = PromptTemplate(
        ...
        template="""Please respond to the following request, denoted by "Request" in the best way possible with the
            ...
            If the paper context does not enough information for confidently respond to the request, please respond with "The paper does not contain enough information
        ...
        if merge_at_end:
            summary_prompt = PromptTemplate(
                ...
                template="""Please merge the following responses (denoted by 'Response N:').
                        ...
                        - You should not omit or duplicate any information that positively answers the initial question.
                        ...
                        Lastly, it is fundamental that the generated answer does not sound like a merge of the original responses, but rather like a single (non-contradicting) response.
                        {responses}
                        Initial Question:
                        {question}
                        Response:
