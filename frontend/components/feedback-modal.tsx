            ...
            <Modal.Body>
              <Flex direction="column" css={{gap: "$10"}}>
                ...
                <Radio.Group
                  ...
                  css={{maxWidth: '450px'}}
                >
                  <StyledRadio size="sm" value="data-exploration" description="(like kaggle)">🔍 Inline data exploration
                    tool </StyledRadio>
                  <StyledRadio size="sm" value="pdf-render">📉 In-app pdf render </StyledRadio>
                  <StyledRadio size="sm" value="similar-items" description="(papers, datasets, models)">🧩 Recommendation
